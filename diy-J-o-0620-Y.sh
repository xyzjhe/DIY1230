...
#共存
sed -i 's/com.github.tvbox.osc/com.xp.xxxBox/g' $CURRENT_DIR/$DIR/app/build.gradle
...
# 内置接口
sed -i 's#API_URL, ""#API_URL, "https://ghproxy.net/https://raw.githubusercontent.com/xyzjhe/XYQTVBox/main/XYQTVBox.json"#g'   $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/api/ApiConfig.java
