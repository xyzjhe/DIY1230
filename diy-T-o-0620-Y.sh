...
# 内置接口
sed -i 's#"app_source"><#"app_source">https://ghproxy.net/https://raw.githubusercontent.com/xyzjhe/XYQTVBox/main/XYQTVBox.json<#g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
